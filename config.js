...
const defaultOwner = '2347045505096';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '2347045505096' ; // put your number here
...
//
global.botname = process.env.BOTNAME || 'MANJAKAY';
global.pairingNumber = process.env.BOT_NUMBER || '2347045505096' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || '' ;  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['2348064092517', '2347045505096']
...
// Sticker WM
global.premium = 'true'
global.packname = 'manjakay'
global.author = 'Lordkay'
